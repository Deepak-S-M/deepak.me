            ...
            <div className="lg:w-2/3">
              <div className="animate_top rounded-md border border-stroke bg-white p-7.5 shadow-solid-13 dark:border-strokedark dark:bg-blacksection md:p-10">
                ...
                <div className="blog-details">
                  ...
                  <p>
                  <span className="text-black dark:text-white">ஆஷிப் :</span> டேய் தீபக் என்னடா எல்லாரும் வந்துட்டாங்களா.<br></br>
                  <span className="text-black dark:text-white">தீபக்       :</span>  டேய் என்னடா இப்ப தான் வர்ற அங்க எல்லாரும் அப்பவே வந்துடாங்க.<br></br>                        
                  <span className="text-black dark:text-white">ஆஷிப் : </span>  இல்லடா மதியம் அருவிக்கு குளிக்க போனேம்லடா அங்க அலை வரும்போது தண்ணிக்குள்ள முன்கிட்டேன்டா அடுத்து  படில மேல ஏறி          வரும்போது கல்லுல இடிச்சிகிட்டேன் அதான் வந்து வலில  தூங்கிட்டேன்.<br></br>
                  <span className="text-black dark:text-white">தீபக்      :  </span> என்னடா அருவிக்கு குளிக்க போனனு சொன்ன பின்ன அலை வந்துச்சி உள்ள இழுதிச்சினு கூட சொல்ல மாட்டுக்க  முன்கிட்டேன்னு சொல்லுற பின்ன படியேறி மேல வந்துட்டேன்னு சொல்லுற.
                  </p>
